...
archivo_excel = 'COMISIONES.xlsx'  # Reemplaza 'ejemplo.xlsx' con la ruta de tu propio archivo Excel
...
datos_excel.to_csv('COMISIONES.csv', sep=';', index=False, encoding='latin1')
